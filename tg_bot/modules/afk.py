...
def afk(bot: Bot, update: Update):
    ...
    bot.send_message(update.effective_message.chat_id,'**{} Is Now Away!**'.format(update.effective_user.first_name),parse_mode='md',reply_to_message_id=update.effective_message.message_id)
