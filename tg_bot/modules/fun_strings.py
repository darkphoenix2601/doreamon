...
async def alive(client: Client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://telegra.ph/file/ffb0effc64003f4c3936d.jpg",
        caption=f"""**➮𝐳 ʜɪɪ ɪ ᴍ [{BOT_NAME}](https://t.me/{BOT_USERNAME})**
➮ **doreamon Sყʂƚҽɱ Wσɾƙιɳɠ Fιɳҽ**
➮ **doreamon ᴠᴇʀꜱsion : 5.0 Lҽƚҽʂƚ**
➮ **ᴍʏ ᴏᴡɴᴇʀ : [{OWNER_NAME}](https://t.me/akshi_s_ashu1)**
➮ **ꜱᴇʀᴠɪᴄᴇ ᴜᴘᴛɪᴍᴇ : `{uptime}`**
**𝚃𝚑𝚊𝚗𝚔𝚜 𝙵𝚘𝚛 𝚄𝚜𝚒𝚗𝚐 doreamon 𝙱𝚘𝚝𝚜 ♥️**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "ᴄʜᴀɴɴᴇʟ ☑️", url=f"https://t.me/phoenix_music_new"
                    )
                ]
            ]
        )
